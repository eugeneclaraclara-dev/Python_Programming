...
print(sum(a), sum(a))
print(sum(b), sum(b))  # 순회가 끝나서 두 번째 sum 은 0이 나온다.
...
# ✅ 15시간
print(f"{sum(hours[1:6])}시간")

# 2️⃣ 가장 많이 공부한 시간 출력하기
# ✅ 6시간
print(f"{max(hours)}시간")

# 3️⃣ 가장 많이 공부한 요일 출력하기
# ✅ 토요일
print(f"{days[hours.index(max(hours))]}요일")
...
# ✅ (1000, 2000, 5000)
# ✅ (5, 3, 2)
total = sum(price * num for name, price, num in stocks)  # 제너레이터 표현식
print(f"총액: {total:,}원")
# 총 재고 금액 출력
